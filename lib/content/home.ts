...
export const homeContent: Record<Locale, HomeContent> = {
  ...
  ar: {
    hero: {
      ...
      subheadline:
        "أنو للحلول البرمجية تعيد تصميم طريقة عمل شركتك، ثم تطبّق Odoo كمنصة سيطرة للعمليات، المالية، المخزون، المبيعات، والتقارير.",
      ctas: {
    ...
    method: {
      ...
      description:
        "تجمع أنو بين المعمارية المؤسسية، وتفكير النضج على أسلوب CMMI، وتهيئة Odoo، وتدريب المستخدمين، وأدلة العمليات حتى لا يتوقف التحسين عند لحظة الإطلاق.",
      principles: [
    ...
    services: {
      ...
      description:
        "أنو لا تبدأ من الوحدات فقط. كل خدمة ترتبط بالسيطرة، والرؤية، والموافقات، وإشراف المالك.",
      items: [
        {
          key: "odoo",
    ...
    industries: {
      ...
      description:
        "المنهجية عابرة للوظائف، لكن أولويات السيطرة تختلف من قطاع لآخر. أنو تبني التنفيذ حول هذه الفروق.",
      items: [
        {
          key: "distribution",
    ...
    results: {
      ...
      description:
        "أنو لا تنشر قصص نجاح مختلقة. القيمة تُعرض من خلال نتائج تشغيلية واقعية يمكن لنظام سيطرة أفضل أن يدعمها.",
      items: [
        {
