...
export const siteCopy = {
  ...
  ar: {
    ...
    footerDescription:
      "تعمل ANU مع الشركات العراقية التي تحتاج إلى موافقات أوضح وبيانات أدق وتقارير أقوى ورقابة أفضل على التنفيذ اليومي.",
  ...
  ar: {
    ...
    workStory: [
      ...
      },
      {
        ...
        text: "تحدد ANU الأدوار والصلاحيات ومنطق الموافقات وقواعد المخزون والروابط المالية وهيكل التقارير ورؤية المالك قبل بدء إعداد النظام.",
      },
      {
        counter: "٠٣ / ٠٣",
    ...
    method: {
      ...
      methodName: "ANU / منهج الرقابة التشغيلية",
    ...
    industries: {
      ...
      description:
        "اكتشف كيف تنظّم ANU الرقابة التشغيلية ونظام Odoo حول العمل الأهم في كل قطاع.",
...
export const industriesPageCopy = {
  ...
  ar: {
    index: {
      ...
      description:
        "تحدد ANU القرارات والأدلة والتسليمات المهمة في قطاعك، ثم تطبّقها داخل Odoo.",
      ...
      fitDescription:
        "تحافظ ANU على منهج تطبيق واحد مع تكييف نموذج التشغيل والأدلة وأسئلة الإدارة لكل قطاع.",
    },
    showcaseLabel: "القطاعات التي تخدمها ANU",
    breadcrumb: "القطاعات",
    breadcrumbLabel: "مسار الصفحة",
    startAssessment: "ابدأ التقييم",
    changesLabel: "ما الذي تغيّره ANU",
...
export const servicesPageCopy = {
  ...
  ar: {
    ...
    description:
      "تقيّم ANU مسارات العمل والموافقات والمخزون والمشتريات والمبيعات والمالية والتقارير وجودة البيانات والصلاحيات ورؤية الإدارة قبل تهيئة Odoo كمنصة رقابة.",
    directLabel: "ما الذي تقدمه ANU",
    directAnswer:
      "تجمع ANU بين إعادة تصميم العمليات وتطبيق نظام Odoo ERP. نحدد طريقة عمل القرارات والموافقات والسجلات والاستثناءات، ثم نهيئ الوحدات والصلاحيات ولوحات المعلومات والتكاملات اللازمة لتشغيل هذا النموذج كل يوم.",
    services: [
      {
        title: "إعادة تصميم العمليات",
