...
export function HomeHero() {
  return (
    <>
      ...
      <section className="bg-[var(--color-bone-white)] px-3 pt-3" data-motion-hero>
      <div className="hero-lab-visual relative flex min-h-[calc(100svh-12px)] overflow-hidden rounded-t-2xl bg-[var(--color-abyssal-ink)] text-white" data-lab-visual data-intro-visual>
        <div className="hero-bg-motion" data-hero-bg aria-hidden="true" />
        <div className="relative z-10 flex min-h-[calc(100svh-12px)] w-full flex-col px-9 pb-8 pt-36 sm:px-12 sm:pt-40">
          <h1 className="max-w-[980px] text-[clamp(3.42rem,7.78vw,7rem)] leading-none tracking-[-0.03em]" data-intro-title>
            Business control,
            <br />
            implemented.
          </h1>
          ...
          <div className="mt-auto grid gap-6 lg:grid-cols-[minmax(0,620px)_auto] lg:items-end lg:justify-between">
            <p className="max-w-[620px] text-[clamp(1.25rem,1.55vw,1.5rem)] leading-[1.12] tracking-[-0.03em] text-white" data-intro-copy>
            ...
            <div className="flex flex-wrap items-center gap-2 lg:justify-end" data-intro-actions>
